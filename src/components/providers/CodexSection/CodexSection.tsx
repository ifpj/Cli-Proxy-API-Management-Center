...
import { IconModelCluster, IconPencil, IconPlay, IconTrash2 } from '@/components/ui/icons';
              ...
              <Fragment>
                <div className={styles.providerCardTopBar}>
                  <div className={styles.openaiProviderTitle}>
                    <span title={t('ai_providers.codex_item_title')}>
                  ...
                  <div className={styles.openaiProviderTopActions}>
                    <Button
                      ...
                      aria-label={t('ai_providers.codex_test_action')}
